...
angular
  ...
  .config(function ($routeProvider) {
    ...
    var heardTest = {
      ...
      controller: 'TestCtrl',
      info: {
        questionsName: "Серцево-судинна система",
        questions: [
          {
            text: "	Назвіть складові зовнішньої оболонки артерії",
            answers: [
          ...
          {
            text: "	Назвіть артеріальні судини, що належать до м’язового типу",
            answers: [
              "периферійні артерії кінцівок;",
              "сонна артерія;",
              "аорта;",
              "легеневий стовбур;",
              "пахвова артерія."],
          ...
          {
            text: "	Оберіть	вірний	порядок	розташування	частин мікроциркуляторного русла",
            answers: [
              "артеріоли	–	венули	–	капіляри	–	прекапіляри	– посткапіляри;",
              "венули   –   артеріоли   –   прекапіляри   –   посткапіляри  – капіляри;",
              "артеріоли   –  капіляри   –   посткапіляри   –   прекапіляри – венули;",
              "артеріоли  –  прекапіляри  –  капіляри  –  посткапіляри      – венули;",
              "капіляри   –  прекапіляри   –   посткапіляри  –   артеріоли  – венули."],
            correctAnswer: 3
          },

          {
            text: "	Оберіть послідовність у якій відбувається зміна джерел кровотворення",
            answers: [
              "жовтковий мішок – мезенхима – селезінка – червоний кістковий мозок – печінка;",
              "мезенхима – жовтковий мішок – червоний  кістковий  мозок – селезінка – печінка;",
              "печінка – селезінка – жовтковий мішок – червоний кістковий мозок – мезенхима;",
              "мезенхима  –  жовтковий  мішок  –  печінка  –  селезінка  – червоний кістковий мозок;",
              "червоний кістковий мозок – мезенхима –  жовтковий  мішок – селезінка – печінка."],
            correctAnswer: 3
          },

          {
            text: "	Відносно очеревини селезінка розташована …",
            answers: [
              "… екстраперитонеально;",
              "… інтраперитонеально;",
              "… мезоперитонеально."],
          ...
          {
            text: "	Пупкові артерії містять …",
            answers: [
              "… венозну кров;",
              "… артеріальну кров;",
              "… венозно-артеріальну кров."],
            correctAnswer: 2
          },

          {
            text: "	Пупкова вена містить …",
            answers: [
              "… венозну кров;",
              "… артеріальну кров;",
              "… венозно-артеріальну кров."],
          ...
          {
            text: "	У нормі овальний отвір закривається …",
            answers: [
              "… до народження;",
...

          {
            ...
            answers: [
              ...
              "IV міжребровий проміжок, справа;",
              "V міжребровий проміжок, зліва;",
              "V міжребровий проміжок, справа."],
            correctAnswer: 3
          },
